            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden mt-[120px]">
                <div className="absolute inset-0">
                    <div
                        ...
                        style={{
                            backgroundImage: `url('https://images.unsplash.com/photo-1431540015161-0bf868a2d407?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80')`
                        }}
                    ></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-noir/70 via-noir/50 to-transparent"></div>
                </div>
                ...
                <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <p className="font-body text-lg text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Un espace professionnel et élégant pour vos événements d'entreprise
                        </p>
                    </motion.div>
                </div>
            </section>
